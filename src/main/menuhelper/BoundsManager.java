...
public class BoundsManager {
    ...
    private static final Rectangle emptyUserLblBounds = new Rectangle(x - 92, y + 300, width + 170, height - 10);
    private static final Rectangle emptyPwLblBounds = new Rectangle(x - 90, y + 300, width + 160, height - 10);
    ...
    public static Rectangle getEmptyUserLblBounds() { return emptyUserLblBounds; }
    public static Rectangle getEmptyPwLblBounds() { return emptyPwLblBounds; }
    ...
    private static final Rectangle userFieldBounds = new Rectangle(x + 125, y, width - 80, height);
    private static final Rectangle pwFieldBounds = new Rectangle(x + 125, y + 75, width - 80, height);
