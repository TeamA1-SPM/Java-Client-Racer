...
public class BoundsManager {
    ...
    public static final Rectangle MhBtnBounds = new Rectangle(x, y + 150, width, height);
    public static final Rectangle MhBackBtnBounds = new Rectangle(x, y + 300, width, height);
    ...
    public static final Rectangle UserNotFoundBounds = new Rectangle(x - 70, y + 300, width + 100, height - 10);
